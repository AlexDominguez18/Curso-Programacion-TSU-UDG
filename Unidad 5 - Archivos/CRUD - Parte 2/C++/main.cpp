...
int main()
{
    ...
    Guardado guardado = ALEATORIO;

    inicializarProductos(productos);
    if (guardado == SECUENCIAL) leerArchivoSecuencial(productos, &cantidadProductos);
    ...
    do
    {
        ...
        if (continuarPrograma)
            ...
            cout << "Gracias por usar Alex Shop" << endl;

    } while (continuarPrograma);

    if (guardado == SECUENCIAL) escribirArchivoSecuencial(productos, cantidadProductos);
...
int elegirOpcionMenu()
{
    ...
    limpiarPantalla();
    cout << "BIENVENIDO - ALEX SHOP" << endl
         << endl;
